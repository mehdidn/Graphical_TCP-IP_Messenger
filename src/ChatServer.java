...
public class ChatServer extends Application {
    ...
    // Log and userList labels
    private Label logLabel = new Label("Log");
    private Label userListLabel = new Label("Active User");


    // ArrayList for storing users and chat messages
    private ArrayList<String> logList = new ArrayList<>();
    private ArrayList<String> userList = new ArrayList<>();

    // List view for log and user
     ...
     */
    private ObservableList<String> logItems = FXCollections.observableArrayList (logList);
    ...
    public void start(Stage primaryStage) {
        ...
        gridPane.add(userListLabel,0,2);
    ...
    class ServerThread extends Thread {
        ...
        public void run() {
             ...
             */
                ...
                Platform.runLater(() -> logItems.add("Connection Closed for " + userName));
